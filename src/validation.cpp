...
#if defined(NDEBUG)
# error "Leolitecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Leolitecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LLC additional fees, %d delta bytes\n",
