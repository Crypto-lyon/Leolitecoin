...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/leolitecoin-project/leolitecoin>";
    const std::string URL_WEBSITE = "<https://leolitecoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Leolitecoin version %s\n", FormatFullVersion());
}
