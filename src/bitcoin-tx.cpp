...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s leolitecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  leolitecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded leolitecoin transaction") + "\n" +
              "  leolitecoin-tx [options] -create [commands]   " + _("Create hex-encoded leolitecoin transaction") + "\n" +
              "\n";
